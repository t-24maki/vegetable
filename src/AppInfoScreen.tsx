...
const AppInfoScreen: React.FC = () => {
  const sections: Section[] = [
    ...
    {
      title: 'データソース',
      content: '農林水産省が月3回報告する「青果物卸売市場調査（旬別調査）」を元にしています。数値は主要卸売市場における価格に基づいており、店舗での価格とは異なります。「旬」マークと保存方法は生成AIの回答を反映しています。',
      icon: 'server-outline'
    },
    {
      title: '価格比較について',
      content: '「直近1ヶ月との比」は、直前3回分の報告値の平均と比較した結果を示しています。「例年同月との比」は、2023年以降のの同月平均価格と比較した結果を表示しています。',
